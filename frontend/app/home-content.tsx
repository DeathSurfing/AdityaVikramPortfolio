...
function StarShape({
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          <linearGradient id={`starGradientLight-${size}`} x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="rgba(30, 58, 138, 0.9)" />
            <stop offset="50%" stopColor="rgba(59, 130, 246, 0.7)" />
            <stop offset="100%" stopColor="rgba(30, 58, 138, 0.5)" />
          </linearGradient>
          <linearGradient id={`starGradientDark-${size}`} x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        {/* Star shape for light mode */}
        <path
          d={starPath}
          fill={`url(#starGradientLight-${size})`}
          stroke="rgba(30, 58, 138, 0.8)"
          strokeWidth="2"
          filter={`url(#starGlow-${size})`}
          className="drop-shadow-lg block dark:hidden"
        />
        
        {/* Star shape for dark mode */}
        <path
          d={starPath}
          fill={`url(#starGradientDark-${size})`}
...
// This is now a proper React component for lazy loading
export function HomeContent({ onSwitchToChatbot }: { onSwitchToChatbot?: () => void }) {
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            <Button
              ...
              size="lg"
              className="bg-gradient-to-r from-primary via-primary to-accent hover:from-primary/90 hover:to-accent/90 text-white rounded-full shadow-lg transition-all duration-300 hover:scale-105 px-8 py-4"
            >
