    ...
    <div className={cn("bg-background relative flex min-h-screen w-full items-center justify-center overflow-hidden", inter.variable, playfair.variable)}>
      ...
      <div className="relative z-10 container mx-auto max-w-6xl px-6 pt-16 md:pt-20 lg:pt-24">
        <div className="text-center space-y-12">
          ...
          {/* Primary CTAs */}
          <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible" className="flex flex-wrap justify-center gap-4">
            <a
            ...
            <a
              href="/whoami"
              className="inline-flex items-center gap-2 bg-card border border-border/50 text-foreground px-8 py-4 rounded-xl font-semibold hover:bg-card/80 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl group"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-card border border-border/50 text-foreground px-8 py-4 rounded-xl font-semibold hover:bg-card/80 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
            >
          ...
          {/* Quick Stats */}
          <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible" className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">

            {/* Current Internship */}
            <div className="bg-card border border-border/50 rounded-2xl p-6 text-center group hover:scale-105 transition-all duration-300">
              ...
              <div className="text-xs text-muted-foreground mt-2">Tech Secratary Of Woxsen Student Council</div>
            </div>

            {/* Featured Projects */}
            <div className="bg-card border border-border/50 rounded-2xl p-6 text-center group hover:scale-105 transition-all duration-300">
              <Code2 className="h-10 w-10 text-orange-500 mx-auto mb-4" />
          ...
          {/* Value Proposition */}
          <motion.div custom={3} variants={fadeUpVariants} initial="hidden" animate="visible" className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center">What I Bring to Your Team</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-card border border-border/40 rounded-2xl p-6 text-left group hover:bg-card/50 transition-colors">
          ...
          {/* Tech Stack */}
          <motion.div custom={4} variants={fadeUpVariants} initial="hidden" animate="visible" className="space-y-6">
            ...
            <div className={cn("flex flex-wrap justify-center gap-3 max-w-4xl mx-auto", geistMono.className)}>
              {[
                ...
                <span
                  key={tech.name}
                  className="px-4 py-2 text-sm rounded-full border font-medium transition-all hover:scale-105"
                >
                  {tech.name}
                </span>
              ))}
          ...
          {/* Secondary CTAs */}
          <motion.div custom={5} variants={fadeUpVariants} initial="hidden" animate="visible" className="space-y-6">
            <div className="flex flex-wrap justify-center gap-4">
              <a
                href="/projects"
                className="inline-flex items-center gap-2 bg-card border border-border/50 text-foreground px-6 py-3 rounded-xl font-medium transition-all duration-300 hover:bg-card/80 group"
              >
                View My Projects
          ...
          {/* Final Summary */}
          <motion.div custom={6} variants={fadeUpVariants} initial="hidden" animate="visible" className="max-w-3xl mx-auto">
