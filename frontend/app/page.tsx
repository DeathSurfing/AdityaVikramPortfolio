...
// fonts: reduced weights + display swap
const inter = Inter({
  subsets: ["latin"],
  weight: ["400", "700"],
  display: "swap",
  ...
  return (
    ...
    <div className={cn("bg-background relative w-full overflow-hidden", inter.variable, playfair.variable)}>
      ...
      <section className="relative flex min-h-screen w-full items-center justify-center">
        <div className="from-primary/20 dark:from-primary/30 absolute inset-0 bg-gradient-to-br via-transparent to-rose-500/10" />

        {/* Animated background (lazy, client-only) */}
        ...
        <div className="relative z-10 container mx-auto max-w-6xl px-6 py-20">
          <div className="text-center space-y-12">
            ...
            {/* Three Primary CTAs */}
            <div className="flex flex-wrap justify-center gap-4 md:gap-6 animate-fade-up" style={{ animationDelay: "0.35s" }}>
              <a href="/whoami" className="inline-flex items-center gap-2 bg-gradient-to-r from-marron-600 to-red-600 text-white px-8 py-4 rounded-xl font-semibold hover:scale-105 shadow-md text-lg group">
                <User className="h-5 w-5" />
                Who Am I?
                <ArrowRight className="h-4 w-4 ml-1 group-hover:translate-x-1 transition-transform" />
              </a>

              <a href="/experience" className="inline-flex items-center gap-2 bg-green-600 text-primary-foreground px-8 py-4 rounded-xl font-semibold hover:scale-105 shadow-md text-lg group">
                <Briefcase className="h-5 w-5" />
                Experience
                <ArrowRight className="h-4 w-4 ml-1 group-hover:translate-x-1 transition-transform" />
              </a>

              <a href="/projects" className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-blue-600 text-white px-8 py-4 rounded-xl font-semibold hover:scale-105 shadow-md text-lg group">
      ...
      {/* The rest of your sections remain largely unchanged but use animate-fade-up and animate-bob classes */}
        ...
        <div className="relative z-10 container mx-auto max-w-6xl px-6">
          <div className="space-y-16">
            ...
            <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
              {/* ... your 4 cards, keep animate-fade-up on each card with small delays */}
              <div className="bg-card border border-border/40 rounded-2xl p-8 text-left group hover:bg-card/50 transition-all hover:scale-[1.02] animate-fade-up" style={{ animationDelay: "0.2s" }}>
              ...
              <div className="bg-card border border-border/40 rounded-2xl p-8 text-left group hover:bg-card/50 transition-all hover:scale-[1.02] animate-fade-up" style={{ animationDelay: "0.25s" }}>
                <div className="flex items-start gap-4">
              ...
              <div className="bg-card border border-border/40 rounded-2xl p-8 text-left group hover:bg-card/50 transition-all hover:scale-[1.02] animate-fade-up" style={{ animationDelay: "0.3s" }}>
                <div className="flex items-start gap-4">
              ...
              <div className="bg-card border border-border/40 rounded-2xl p-8 text-left group hover:bg-card/50 transition-all hover:scale-[1.02] animate-fade-up" style={{ animationDelay: "0.35s" }}>
                <div className="flex items-start gap-4">
      ...
      <section className="relative min-h-screen flex items-center py-24">
        ...
        <div className="relative z-10 container mx-auto max-w-6xl px-6">
          <div className="space-y-12">
            ...
            <div className="flex flex-wrap justify-center gap-4 max-w-5xl mx-auto animate-fade-up" style={{ animationDelay: "0.15s" }}>
              {[
                ...
                <span
                  key={tech.name}
                  className={`
                    px-6 py-3 text-base rounded-full border-2 font-medium
                    transition-all hover:scale-110 ${tech.color}
                    animate-fade-up
                  `}
      ...
      {/* Final CTA */}
      <section className="relative min-h-screen flex items-center py-24">
        <div className="from-primary/20 absolute inset-0 bg-gradient-to-br via-transparent to-purple-500/10" />
        <div className="relative z-10 container mx-auto max-w-4xl px-6">
          <div className="space-y-12 text-center animate-fade-up">
